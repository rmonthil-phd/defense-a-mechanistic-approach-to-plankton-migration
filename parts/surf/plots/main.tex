		...
		\begin{tikzpicture}[
			...
			\begin{axis}[
				...
				\addplot [
					...
					select coords between index={0}{\j},
					unbounded coords=discard,
				]{../data/flow_taylor_green_vortex__angle_0o0__initial_position_0o_0o__surfer__tau_1o5707963267948966_trajectory.csv} node[pos=1, mark size=0.6mm]{\pgfuseplotmark{square*}};
				...
				\addplot3 [
					...
					select coords between index={\j}{\j+1},
					unbounded coords=discard,
				]{../data/flow_taylor_green_vortex__angle_0o0__initial_position_0o_0o__surfer__tau_1o5707963267948966_trajectory.csv};
				% direction
